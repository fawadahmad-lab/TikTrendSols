...
const About = () => {
  ...
  const faqs = [
    {
      question: "What makes Tokgrowth different from other marketing agencies?",
  ...
  const content = {
    mission: (
      <div className="space-y-4">
        ...
        <p className="text-purple-700">
          At Tokgrowth, we're on a mission to revolutionize how brands connect with audiences on TikTok.
    ...
    story: (
      <div className="space-y-4">
        ...
        <p className="text-purple-700">
          Founded in 2021 by TikTok marketing experts, Tokgrowth started as a small team helping local businesses
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-purple-900 mb-4">
            About <span className="text-purple-600">Tokgrowth</span>
          </h2>
        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="w-full md:w-2/3 text-center md:text-left">
              ...
              <p className="text-purple-700">
                Zahid, the CEO of TokgrowthSolutions, leads a TikTok-focused e-commerce agency dedicated to helping brands scale their sales through TikTok Shop. The agency specializes in strategy, marketing, and optimization to drive viral growth and maximize conversions
              </p>
            </div>
          </div>
        </motion.div>
